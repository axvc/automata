...
import { ALL_PATTERNS, PATTERNS_BY_CATEGORY, type Pattern } from '../../utils/patterns';
        ...
        {(Object.keys(PATTERNS_BY_CATEGORY) as Array<keyof typeof PATTERNS_BY_CATEGORY>).map(
          (category) => (
            <div key={category} className="flex flex-col gap-2">
              <h3 className="text-sm font-mono font-semibold text-text-muted uppercase tracking-wide">
